...
import co.edu.usta.hotel.controllers.ReservationController;
...
public class FormShowReservations extends javax.swing.JInternalFrame {
    ...
    private void load() {
        ...
        List<Reservation> reservations = reservationController.showReservation();
        loadClient(reservations);
    }

    private void loadClient(List<Reservation> reservations) {
        String[] array = new String[6];
        for (Reservation reservation : reservations) {
            array[0] = String.valueOf(reservation.getId());
            array[1] = reservation.getClient().getNames();
            array[2] = reservation.getRoom().getName();
            array[3] = String.valueOf(reservation.getStartDate());
            array[4] = String.valueOf(reservation.getFinalDate());
            array[5] = String.valueOf(reservation.isState());
    ...
    private void loadTable() {
        ...
        tableModel.addColumn("Habitación");
    ...
    private void initComponents() {
        ...
        lbSubtitle.setText("Listar Reservaciones");

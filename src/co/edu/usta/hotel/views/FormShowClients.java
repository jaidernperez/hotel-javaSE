...
public class FormShowClients extends javax.swing.JInternalFrame {
    ...
    private void loadClient(List<Client> clients) {
        String[] array;
        for (Client client : clients) {
            array = new String[5];
            array[0] = client.getDni();
            array[1] = client.getNames();
            array[2] = client.getSurnames();
            array[3] = client.getEmail();
            array[4] = client.getPhone();
    ...
    private void initComponents() {
        ...
        lbSubtitle.setText("Listar Clientes");
